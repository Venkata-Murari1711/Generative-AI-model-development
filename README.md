...
- **Assignment 4:** Comparative Training Methods (Pre-Training (unsupervised), Supervised Fine-Tuning (SFT) and Reinforcement Learning)
   - **Model:** Tiny GPT
   - **Dataset**: WikiText-2  
- **Assignment 5:** Emerging Models Research
   ...
   **Tasks:**
   ...
   - Pose description and spatial reasoning
   - Scene context and emotion inference
   
   #### Case 2: Chart/Graph Analysis
   **Input:** Dual-axis bar/line chart (Units Sold vs. Total Transaction, Jan-Jun)  
   **Tasks:**
   - Dual-axis data extraction
